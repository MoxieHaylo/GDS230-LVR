...
"C:\Program Files\Unity\Hub\Editor\2019.1.0f2\Editor\Data\PlaybackEngines\AndroidPlayer\SDK\platform-tools\adb.exe" install -r C:\Users\hwilson12\Documents\Re-Energise_Alpha02.apk
